...
const AlMahaMap = () => {
  ...
  return <div className="aspect-video bg-gradient-to-br from-primary/5 to-primary/10 p-6 rounded-2xl relative overflow-hidden">
      ...
      <div className="relative z-10 h-full bg-white rounded-xl overflow-hidden shadow-2xl border border-white/20">
        <iframe src={openStreetMapUrl} width="100%" height="100%" style={{
        border: 0
      }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Al Maha Island Location" className="w-full h-full" />
        ...
        <div className="absolute bottom-4 right-4">
          <a href={`https://www.google.com/maps/search/?api=1&query=${latitude},${longitude}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-3 py-2 bg-primary text-primary-foreground text-xs font-gotham-medium rounded-lg shadow-lg hover:bg-primary/90 corporate-transition">
            Open in Maps
